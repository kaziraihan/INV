...
<body>
    <div class="container-fluid">
        ...
        <p><b> Next Sourcing Service limited </b><br> Archived Item</br><?php echo "Printed : " . htmlspecialchars(string:$current_date); ?> Printed by : 
        <?php include "../includes/login.php"; echo $_SESSION['fname']; ?></p> 
            ...
            <tbody>
                ...
                $query = "SELECT * FROM asset_list WHERE Disposed = '9'";
