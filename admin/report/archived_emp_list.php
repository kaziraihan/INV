...
<head>
    ...
    <title>Archieved Emp Report</title>
...
<body>
    <div class="container-fluid">
        ...
        <p><b> Next Sourcing Service limited </b><br> Archieved Emp List<br><?php echo "Printed : " . htmlspecialchars(string:$current_date); ?> Printed by : 
    ...
    <script>
        function downloadPDF() {
            ...
            doc.save("Archieved_emp_report.pdf");
        }
    </script>
</body>
</html>
